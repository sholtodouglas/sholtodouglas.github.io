...
<figure>
    ...
    <figcaption>The goal conditioned hierarchial framework shared by HAC and RPL.  The superscripts on the policies stand for higher and lower level. Image from the [RPL Paper](https://relay-policy-learning.github.io/).</figcaption>
</figure>
